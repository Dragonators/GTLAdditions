...
| --- | --- |
| Java | `>= 21` |
| GTLCore (`gtlcore`) | `>= 1.2.3.2-fix2` |
| Stargate Journey (`sgjourney`) | `0.6.44` only |
...
| --- | --- | --- |
| Nexus Satellite Factory MK-I | Lathe, Bender, Compressor, Forge Hammer, Cutter, Extruder, Mixer, Wiremill, Forming Press, Polarizer | Subspace Corridor Hub module for broad processing recipes |
| Nexus Satellite Factory MK-II | Rock Breaker, Ore Washer, Centrifuge, Electrolyzer, Sifter, Macerator, Dehydrator, Thermal Centrifuge, Electromagnetic Separator | Subspace Corridor Hub module for ore and material processing |
| Nexus Satellite Factory MK-III | Evaporation, Autoclave, Extractor, Brewing, Fermenting, Distillery, Distillation, Fluid Heater, Fluid Solidification, Chemical Bath | Subspace Corridor Hub module for fluid and chemical support recipes |
| Nexus Satellite Factory MK-IV | Canner, Arc Furnace, Lightning Processor, Assembler, Precision Assembler, Circuit Assembler | Subspace Corridor Hub module for assembly and high-value processing |
...
| Subspace Corridor Hub | Interstellar | Main controller for factory modules |
