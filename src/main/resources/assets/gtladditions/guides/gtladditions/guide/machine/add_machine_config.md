...
* Subspace Corridor Hub modules use even distribution before the special hub state is unlocked; after that, they calculate each recipe independently and use special per-recipe parallel limits.
