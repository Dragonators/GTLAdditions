...
object GTLAddMaterial {
    ...
    val MELLION: Material =
        (Material.Builder(GTLAdditions.id("mellion")))
            ...
            .liquid(1000)
            .blastTemp(14000)
            .flags(MaterialFlags.GENERATE_FRAME, MaterialFlags.GENERATE_SMALL_GEAR, MaterialFlags.GENERATE_GEAR, MaterialFlags.GENERATE_DENSE, MaterialFlags.GENERATE_LONG_ROD, MaterialFlags.DISABLE_DECOMPOSITION)
            .color(0x3c0505)
