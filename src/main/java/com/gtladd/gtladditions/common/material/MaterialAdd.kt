...
object MaterialAdd {
    init{
        ...
        GTLMaterials.Hypogen.addFlags(MaterialFlags.GENERATE_BOLT_SCREW, MaterialFlags.GENERATE_FRAME, MaterialFlags.GENERATE_DENSE, MaterialFlags.GENERATE_LONG_ROD)
        ...
        GTMaterials.Plutonium241.getProperty(PropertyKey.FLUID).enqueueRegistration(FluidStorageKeys.PLASMA, (FluidBuilder()).state(FluidState.PLASMA))
    }
