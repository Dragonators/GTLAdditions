...
object MultiBlockStructure {
    ...
    val LIGHT_HUNTER_SPACE_STATION: FactoryBlockPattern? by lazy(LazyThreadSafetyMode.NONE) {
        StructureResourceLoader.loadFactoryPattern(
            "multiblock/light_hunter_space_station.bin",
    ...
    val LIGHT_HUNTER_SPACE_STATION_MODULE: FactoryBlockPattern? by lazy(LazyThreadSafetyMode.NONE) {
        StructureResourceLoader.loadFactoryPattern(
            "multiblock/light_hunter_space_station_module.bin",
            "light_hunter_space_station_module",
            RelativeDirection.RIGHT,
            RelativeDirection.UP,
            RelativeDirection.FRONT
        )
