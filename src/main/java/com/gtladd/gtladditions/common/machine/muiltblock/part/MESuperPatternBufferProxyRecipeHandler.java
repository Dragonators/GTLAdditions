...
public class MESuperPatternBufferProxyRecipeHandler<T> extends NotifiableRecipeHandlerTrait<T> {
    ...
    public MESuperPatternBufferProxyRecipeHandler(MetaMachine machine, IO handlerIO, RecipeCapability<T> capability) {
        super(machine);
