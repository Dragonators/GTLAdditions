...
open class MutableTierCasingMachine(holder: IMachineBlockEntity, tierType: String, vararg args: Any?) :
    TierCasingMachine(holder, tierType, *args),
    IWirelessThreadModifierParallelMachine {
    private var threadPartMachine: IThreadModifierPart? = null

    override fun createRecipeLogic(vararg args: Any): RecipeLogic = MutableRecipesLogic<MutableTierCasingMachine>(this, TIER_CHECK)

    @Suppress("UNCHECKED_CAST")
    override fun getRecipeLogic(): MutableRecipesLogic<MutableTierCasingMachine> = super.getRecipeLogic() as MutableRecipesLogic<MutableTierCasingMachine>
