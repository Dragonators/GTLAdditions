...
class RecipeTypeContributions : RecipeTypeMappingSupplier {
    ...
    companion object {
        private val TYPE_MAP = Object2ObjectOpenHashMap<GTRecipeType, ItemStack>().also {
            ...
            it[GTRecipeTypes.ALLOY_SMELTER_RECIPES] = GTMachines.ALLOY_SMELTER[2].asStack()
            it[GTRecipeTypes.LARGE_CHEMICAL_RECIPES] = GTMachines.LARGE_CHEMICAL_REACTOR.asStack()
            ...
            it[GTLRecipeTypes.MAGIC_MANUFACTURER_RECIPES] = getItemStack("gtceu:magic_manufacturer")
            it[GTLRecipeTypes.WORLD_DATA_SCANNER_RECIPES] = getItemStack("gtceu:opv_world_data_scanner")
