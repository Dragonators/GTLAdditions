...
object Assembler {
    ...
    fun init(provider : Consumer<FinishedRecipe?>) {
        ...
        GTLAddRecipeBuilder("naquadria_charge_more", ASSEMBLER_RECIPES)
            .inputItemString("gtceu:quantum_star")
            .inputItemString("gtceu:industrial_tnt")
            .inputItemString("gtceu:naquadria_dust")
            .inputItemString("gtceu:tiny_hexanitrohexaaxaisowurtzitane_dust", 4)
            .inputItemString("gtceu:double_thorium_plate")
        ...
        GTLAddRecipeBuilder("leptonic_charge", ASSEMBLER_RECIPES)
            .inputItemString("gtceu:gravi_star")
            .inputItemString("gtceu:industrial_tnt")
            .inputItemString("gtceu:degenerate_rhenium_dust")
            .inputItemString("gtceu:small_hexanitrohexaaxaisowurtzitane_dust", 2)
            .inputItemString("gtceu:double_enderium_plate")
        ...
        GTLAddRecipeBuilder("quantum_chromodynamic_charge", ASSEMBLER_RECIPES)
            ...
            .inputItemString("kubejs:unstable_star")
            .inputItemString("kubejs:leptonic_charge")
            .inputItemString("kubejs:quantumchromodynamic_protective_plating")
        ...
        GTLAddRecipeBuilder("electric_blast_furnace", ASSEMBLER_RECIPES)
            ...
            .inputItemString("gtceu:heatproof_machine_casing")
        ...
        GTLAddRecipeBuilder("mega_blast_furnace", ASSEMBLER_RECIPES)
            .inputItemString("gtceu:electric_blast_furnace")
            .InputItems("2x gtceu:naquadah_spring")
            .InputItems("2x gtceu:zpm_field_generator")
            .InputItems("2x gtceu:dense_naquadah_alloy_plate")
            .inputItemString("gtceu:enriched_naquadah_trinium_europium_duranide_quadruple_wire")
        ...
        GTLAddRecipeBuilder("alloy_blast_smelter", ASSEMBLER_RECIPES)
            .inputItemString("gtceu:ev_alloy_smelter")
        ...
        GTLAddRecipeBuilder("vacuum_freezer", ASSEMBLER_RECIPES)
            .inputItemString("gtceu:frostproof_machine_casing")
        ...
        GTLAddRecipeBuilder("mega_vacuum_freezer", ASSEMBLER_RECIPES)
            .inputItemString("gtceu:vacuum_freezer")
            .InputItems("2x gtceu:zpm_field_generator")
            .InputItems("2x gtceu:dense_rhodium_plated_palladium_plate")
            .inputItemsModTag("circuits/zpm")
            .inputItemString("gtceu:ruthenium_trinium_americium_neutronate_quadruple_wire")
    ...
    private fun addDiode(provider : Consumer<FinishedRecipe?>) {
        ...
        for (`val` in diode) {
            ...
            else builder.inputItemString(`val`[1]!!, 4)
            builder.inputItemString("gtceu:" + `val`[2] + "_plate", 2)
                .inputItemString("gtceu:" + `val`[3] + "_cable", 2)
                .inputItemString("gtceu:" + `val`[0] + "_machine_hull")
    ...
    private fun addHermeticCasing(provider : Consumer<FinishedRecipe?>) {
        ...
        for (`val` in hermetic_casing) {
            GTLAddRecipeBuilder(`val` !![3] + "_hermetic_casing", ASSEMBLER_RECIPES)
                .circuitMeta(3)
                .inputItemString("gtceu:" + `val`[5] + "_plate", 8)
                .inputItemString("gtceu:" + `val`[6])
