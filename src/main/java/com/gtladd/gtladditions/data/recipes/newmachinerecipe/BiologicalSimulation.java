...
public class BiologicalSimulation {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        ItemStacks[] itemStacks = {
                ...
                new ItemStacks("ghast", "nether", "minecraft:gunpowder", 60, "minecraft:ghast_tear", 6, 7),
                new ItemStacks("creeper", "overworld", "minecraft:gunpowder", 80, 2),
                new ItemStacks("zombie", "overworld", "minecraft:rotten_flesh", 75, "minecraft:iron_ingot", 6, "minecraft:carrot", 15, "minecraft:potato", 15, 2),
                new ItemStacks("zombie_villager", "overworld", "minecraft:rotten_flesh", 75, "minecraft:iron_ingot", 6, "minecraft:carrot", 15, "minecraft:potato", 15, 2),
                new ItemStacks("husk", "overworld", "minecraft:rotten_flesh", 75, "minecraft:iron_ingot", 6, "minecraft:carrot", 15, "minecraft:potato", 15, 2),
                new ItemStacks("zombified_piglin", "nether", "minecraft:rotten_flesh", 75, "minecraft:gold_ingot", 6, "minecraft:gold_nugget", 10, 3),
                new ItemStacks("pig", "overworld", "minecraft:porkchop", 80, 2),
                new ItemStacks("sheep", "overworld", "minecraft:mutton", 80, "minecraft:white_wool", 50, 2),
                new ItemStacks("skeleton", "overworld", "minecraft:bone", 75, "minecraft:arrow", 65, 2),
                new ItemStacks("slime", "overworld", "minecraft:slime_ball", 50, 3),
                new ItemStacks("spider", "overworld", "minecraft:string", 70, "minecraft:spider_eye", 20, 2),
                new ItemStacks("vindicator", "overworld", "minecraft:emerald", 10, 3),
                new ItemStacks("witch", "overworld", "minecraft:stick", 50, "minecraft:gunpowder", 35, "minecraft:sugar", 35, "minecraft:glass_bottle", 35, "minecraft:redstone", 6, "minecraft:glowstone_dust", 6, "minecraft:spider_eye", 6, 3),
                new ItemStacks("wither_skeleton", "nether", "minecraft:bone", 75, "minecraft:coal", 65, "minecraft:wither_skeleton_skull", 5, 8),
                new ItemStacks("rabbit", "overworld", "minecraft:rabbit", 70, "minecraft:rabbit_hide", 10, "minecraft:rabbit_foot", 5, 3),
                new ItemStacks("donkey", "overworld", "minecraft:leather", 50, 2),
                new ItemStacks("llama", "overworld", "minecraft:leather", 50, 2),
                new ItemStacks("cat", "overworld", "minecraft:string", 50, 2),
                new ItemStacks("panda", "overworld", "minecraft:bamboo", 50, 3),
                new ItemStacks("polar_bear", "overworld", "minecraft:cod", 50, "minecraft:salmon", 50, 3)
        };
        for (ItemStacks i : itemStacks) {
            for (Sword s : swords) generateRecipe(i, s, provider);
    ...
    private static void generateRecipe(ItemStacks item, Sword sword, Consumer<FinishedRecipe> provider) {
        ...
        if (Objects.equals(sword.name, "avaritia:infinity_sword")) builder.notConsumable(sword.name);
        else builder.chancedInputItems(sword.name, sword.damage, 0);
        builder.inputFluids(GTMaterials.Biomass.getFluid(1000 / sword.factor));
    ...
    private static void setspawneggreicpes(ItemStacks item, Consumer<FinishedRecipe> provider) {
        GTLAddRecipeBuilder builder = new GTLAddRecipeBuilder(item.name + "_spawn_egg", GTLRecipeTypes.INCUBATOR_RECIPES)
                .inputItems("minecraft:bone", 4).inputFluids(GTMaterials.Biomass.getFluid(1000)).inputFluids(GTMaterials.Milk.getFluid(1000));
    ...
    static class ItemStacks {
        ...
        public ItemStacks(String name, String data, String o1, double o1f, String o2, double o2f, String o3, double o3f, String o4, double o4f, String o5, double o5f, String o6, double o6f, String o7, double o7f, int EUt) {
            this.name = name;
            this.data = data;
            O1 = o1;
            O1f = o1f;
        ...
        public ItemStacks(String name, String data, String o1, double o1f, int EUt) {
            this.name = name;
            this.data = data;
            O1 = o1;
            O1f = o1f;
        ...
        public ItemStacks(String name, String data, String o1, double o1f, String o2, double o2f, int EUt) {
            this.name = name;
            this.data = data;
            O1 = o1;
            O1f = o1f;
        ...
        public ItemStacks(String name, String data, String o1, double o1f, String o2, double o2f, String o3, double o3f, int EUt) {
            this.name = name;
            this.data = data;
            O1 = o1;
            O1f = o1f;
        ...
        public ItemStacks(String name, String data, String o1, double o1f, String o2, double o2f, String o3, double o3f, String o4, double o4f, int EUt) {
            this.name = name;
            this.data = data;
            O1 = o1;
            O1f = o1f;
