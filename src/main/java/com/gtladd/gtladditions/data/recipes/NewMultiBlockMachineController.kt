...
object NewMultiBlockMachineController {
    ...
    fun init(provider : Consumer<FinishedRecipe?>) {
        ...
        SUPRACHRONAL_ASSEMBLY_LINE_RECIPES.recipeBuilder(GTLAdditions.id("taixu_turbid_array"))
            ...
            .stationResearch { b : StationRecipeBuilder? ->
                b !!.researchStack(LARGE_RECYCLER.asStack())
                    .dataStack(TOOL_DATA_MODULE.asStack())
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder(GTLAdditions.id("super_input_dual_hatch"))
            ...
            .inputItems(getItemStack("gtmthings:ev_huge_dual_hatch", 64))
            .inputItems(getItemStack("gtmthings:iv_huge_dual_hatch", 64))
            .inputItems(getItemStack("gtmthings:luv_huge_dual_hatch", 64))
            .inputItems(getItemStack("gtmthings:zpm_huge_dual_hatch", 64))
            .inputItems(getItemStack("gtmthings:uv_huge_dual_hatch", 64))
