...
public class AE2 {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        new GTLAddRecipeBuilder("cell_component_1k", FORMING_PRESS_RECIPES)
        ...
        new GTLAddRecipeBuilder("singularity_1", MATTER_FABRICATOR_RECIPES)
                .inputItems("kubejs:scrap", 4320).circuitMeta(3)
                .outputItems("ae2:singularity")
                .TierEUtVA(9).duration(1).save(provider);
        new GTLAddRecipeBuilder("singularity_2", MATTER_FABRICATOR_RECIPES)
        ...
        new GTLAddRecipeBuilder("energy_cell", ASSEMBLER_RECIPES)
        ...
        new GTLAddRecipeBuilder("dense_energy_cell", ASSEMBLER_RECIPES)
