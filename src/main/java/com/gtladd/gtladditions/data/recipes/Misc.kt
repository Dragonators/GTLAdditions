...
object Misc {
    ...
    fun init(provider : Consumer<FinishedRecipe?>) {
        GTLRecipeTypes.DECAY_HASTENER_RECIPES.recipeBuilder(GTLAdditions.id("tiranium50"))
        ...
        GTLRecipeTypes.DOOR_OF_CREATE_RECIPES.recipeBuilder(GTLAdditions.id("command_block"))
        ...
        GTLRecipeTypes.DOOR_OF_CREATE_RECIPES.recipeBuilder(GTLAdditions.id("magmatter_block"))
            .inputItems(getItemStack("gtceu:magmatter_ingot", 64))
            .outputItems(getItemStack("gtceu:magmatter_block"))
            .dimension(ResourceLocation("overworld"))
            .EUt(GTValues.V[14]).duration(1200).save(provider)
        GTLRecipeTypes.CREATE_AGGREGATION_RECIPES.recipeBuilder(GTLAdditions.id("chain_command_block"))
            ...
            .EUt(GTValues.V[14]).duration(1200)
            .save(provider)
        GTLRecipeTypes.CREATE_AGGREGATION_RECIPES.recipeBuilder(GTLAdditions.id("repeating_command_block"))
