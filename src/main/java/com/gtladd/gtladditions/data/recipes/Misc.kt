...
object Misc {
    ...
    fun initAdditionMaterial(provider: Consumer<FinishedRecipe?>) {
        ...
        BLAST_RECIPES.recipeBuilder(id("hot_mellion_ingot"))
            ...
            .duration(856)
            .save(provider)
        VACUUM_RECIPES.recipeBuilder(id("cool_hot_mellion_ingot"))
            .inputItems(ingotHot, MELLION)
            .inputFluids(Helium.getFluid(FluidStorageKeys.LIQUID, 500))
            .outputItems(ingot, MELLION)
            .outputFluids(Helium.getFluid(250))
            .EUt(VA[MV].toLong())
            .duration((MELLION.mass * 3).toInt().coerceAtLeast(1))
            .save(provider)
